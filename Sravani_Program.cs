        ...
        */
        ...
        public static IList<IList<int>> FindMissingRanges(int[] nums, int lower, int upper)
        {
            try
            {
                ...
                List<IList<int>> list1 = new List<IList<int>>();
                if(nums.Length == 1){
                    ...
                    if(nums[0] == lower){
                        ...
                        List<int> innerList1 = new List<int> ( lower, nums[0] );
                        list1.Add( lower+1, nums[0]-1 );
                        List<int> innerList2 = new List<int> ( nums[0], upper );
                        list1.Add(nums[0]+1, upper-1);
        ...
        */
        ...
        // Write your code here and you can modify the return value according to the requirements
            ...
            while (lt <= rt)
            {
                ...
                if (!strobogrammaticMap.ContainsKey(ltCr) || strobogrammaticMap[ltCr] != rtCr || !strobogrammaticMap.ContainsKey(rtCr) || strobogrammaticMap[rtCr] != ltCr)
                {
                    return false;
                }
